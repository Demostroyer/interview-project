...
\item{Users with some computer science background, and understand the internal workings of data structures and other concepts. These people would generally find most problems approachable.}
...
\item{Finally there would be people who are interested in learning to code who have no experience, but will have to put a lot of study in to grasp even basic concepts.}
\end{enumerate}
