...
public class majorityElement169 {
	    ...
	    public int majorityElement(int[] num) {
	    	//majority is first element to begin with. Count is 1 at first as the first element has a count of 1.
	        ...
	        for(int i=1; i<num.length;i++){
	            if(count==0){//if we ever reach 0, then it was not in it more than n/2.
	                ...
	                majority=num[i];//restart with the current element found at index i.
